...
icons = ["","","","","","","Home"," Chill"," Spotify"," Discord"," Steam"," Gaming"]
...
def update_workspace(active_workspace):
    ...
    prompt = f"(box (label :text \"{icons[icons_index[0]]}  {icons[icons_index[1]]}  {icons[icons_index[2]]}  {icons[icons_index[3]]}  {icons[icons_index[4]]}  {icons[icons_index[5]]}\" ))"
